  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen">
      ...
      <div className="flex gap-4 mb-4">
        <Link to="/admin/assets" className="text-blue-600 font-medium hover:underline">
          Assets Assign
        </Link>

        <Link to="/admin/assets/upload-excel" className="text-blue-600 font-medium hover:underline">
          Upload Excel
        </Link>

        <Link to="/admin/assets/history" className="text-blue-600 font-bold underline">
          Asset History
        </Link>
      </div>
